		...
		if page.route == "/activities":
			page.views.append(
				ft.View(
					route="/activities",
					controls=[
						ft.AppBar(title=ft.Text("Activities"), bgcolor=ft.Colors.SURFACE_CONTAINER_HIGHEST),
						ft.Column(
							[
								ft.Container(
			...
			page.views.append(
				ft.View(
					route="/focus",
					controls=[
						ft.AppBar(title=ft.Text("Focus"), bgcolor=ft.Colors.SURFACE_CONTAINER_HIGHEST),
						ft.Column(
							[
								ft.Container(
									content=focus_page(),
			...
			page.views.append(
				ft.View(
					route="/skills",
					controls=[
						ft.AppBar(title=ft.Text("Skills"), bgcolor=ft.Colors.SURFACE_CONTAINER_HIGHEST),
						ft.Column(
							[
								ft.Container(
									content=skills_page(),
